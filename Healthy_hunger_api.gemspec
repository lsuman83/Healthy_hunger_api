...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{"Welcome to my Healthy hunger API"}
  spec.description   = %q{"This API will help create a meal plan per day or per week with healthy options and recipes for those options"}
